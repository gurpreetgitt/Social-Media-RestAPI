...
//import org.springframework.http.converter.json.MapppingJacksonValue;
...
public class FilteringController {
	...
	public MappingJacksonValue filtering() {
		SomeBean someBean = new SomeBean("value1","value2","value3");
		 ...
		 MappingJacksonValue m=new  MappingJacksonValue(someBean);
	...
	public MappingJacksonValue filteringList() {
		...
		MappingJacksonValue m=new  MappingJacksonValue(list);
